											...
											<table class="shop_table">
												...
												<tbody>
													...
													<tr class="cart_item">
														<td class="product-name">
															<?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <strong class="product-quantity">× <?php echo htmlspecialchars( $value1["quantidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> 
														</td>
												...
												<tfoot>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$</span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
